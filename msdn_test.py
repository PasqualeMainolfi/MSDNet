...
from msdnet_tools.scanner import Scanner
import pygame as pg
...
scanner = Scanner(masses=net.masses)
rand_path = scanner.generate_rand_path(path_length=10, coordinate="y")
...
while run:
    ...
    # scanning
    scanned_path = scanner.scan(masses_motion=network, path=rand_path)
